...
use crate::packets::{delivery::*, message::*, *};
...
pub struct Peer<Connection> {
    // TODO(alex) #1 [low] 2021-08-22: A very simple way to handle wrapping (and make sequence be
    // an u16) would be to store a pair, such as:
    /// ```
    /// struct Sequence {
    ///     sequence: NonZeroU64,
